...
export default {
  async fetch(request, env) {
    ...
    // hero images via Workers AI. Not linked anywhere on the site.
...
// Manually-keyed, undocumented endpoint used to generate the PS1/N64-style
// hero images via Workers AI (flux-1-schnell). Not linked anywhere on
// the site and not meant to stay live long-term, remove this route and
// function once the one-time image batch is done.
const GEN_IMAGE_KEY = "sg-n64-batch-r4t9k2";
